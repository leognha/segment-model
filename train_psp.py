...
from eval_psp import eval_net
from miou_psp import miou_loss


from torch.utils.tensorboard import SummaryWriter
from utils.dataset import BasicDataset
# from utils.ce_dataset import ImageFolder
from utils.train_psp_utils import get_args
...
dir_checkpoint = 'checkpoints_psp_17w/'
...
if __name__ == '__main__':
    ...
    ACTIVATION = 'sigmoid'
    net = smp.PSPNet(encoder_name=ENCODER, encoder_weights=ENCODER_WEIGHTS, classes=1, activation=ACTIVATION,in_channels=3)
