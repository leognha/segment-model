...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/home/leognha/Desktop/seg-model/MedicalImage_Project02_Segmentation/checkpoints_seg_17w/CP_epoch2.pth',
                        help='Load model from a .pth file') #'/home/leognha/Desktop/seg-model/MedicalImage_Project02_Segmentation/checkpoints_seg/CP_epoch10.pth'
