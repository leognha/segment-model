...
def get_args():
    parser = argparse.ArgumentParser(description='Train the PSPNet on images and target masks', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/home/leognha/Desktop/seg-model/MedicalImage_Project02_Segmentation/checkpoints_psp_17w/CP_epoch2.pth',
