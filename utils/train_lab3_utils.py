...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/home/leognha/Desktop/seg-model/MedicalImage_Project02_Segmentation/checkpoints_lab3_17w/CP_epoch2.pth',
