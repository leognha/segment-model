...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='./checkpoints_lab3_split/split1/CP_epoch10.pth', metavar='FILE',
                        help="Specify the file in which the model is stored")
    parser.add_argument('--input', '-i', type=str, default='/home/leognha/Desktop/Advanced-BicycleGAN-mask/PPT/9112/',
