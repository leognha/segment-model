...
from utils.test_psp_utils import get_args
...
if __name__ == "__main__":
    ...
    ACTIVATION = 'sigmoid'
    net = smp.PSPNet(encoder_name=ENCODER, encoder_weights=None, classes=1, activation=ACTIVATION,in_channels=3)
    ...
    #net.load_state_dict(torch.load("/home/leognha/Desktop/seg-model/MedicalImage_Project02_Segmentation/checkpoints_psp/CP_epoch10.pth"))
    ...
    for i, fn in enumerate(in_files):
        ...
        #mask_gt = Image.open(mask_files[i])
